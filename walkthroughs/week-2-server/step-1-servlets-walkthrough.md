...
Specifically, open the `PageViewServlet.java` file. This is a servlet class that
...
The `portfolio` directory contains a servlet in the `DataServlet.java` file.

Run your portfolio's dev server and navigate to the `/data` URL to see the
content generated by this servlet.
